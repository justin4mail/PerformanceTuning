...
public class HelloResourceRouter extends RestxRouter {
    ...
    public HelloResourceRouter(
        ...
        new StdEntityRoute<Void, app1.domain.Message>("default#HelloResource#sayHello",
                readerRegistry.<Void>build(Void.class, Optional.<String>absent()),
                writerRegistry.<app1.domain.Message>build(app1.domain.Message.class, Optional.<String>absent()),
                new StdRestxRequestMatcher("GET", "/message"),
                HttpStatus.OK, RestxLogLevel.DEFAULT) {
            @Override
            protected Optional<app1.domain.Message> doRoute(RestxRequest request, RestxRequestMatch match, Void body) throws IOException {
            ...
            protected void describeOperation(OperationDescription operation) {
                ...
                operation.outEntitySchemaKey = "app1.domain.Message";
                operation.sourceLocation = "app1.rest.HelloResource#sayHello()";
            }
        },
        new StdEntityRoute<Void, app1.domain.Message>("default#HelloResource#helloPublic",
                readerRegistry.<Void>build(Void.class, Optional.<String>absent()),
                writerRegistry.<app1.domain.Message>build(app1.domain.Message.class, Optional.<String>absent()),
            ...
            protected void describeOperation(OperationDescription operation) {
                ...
                operation.inEntitySchemaKey = "";
                operation.outEntitySchemaKey = "app1.domain.Message";
                operation.sourceLocation = "app1.rest.HelloResource#helloPublic(java.lang.String)";
            }
        },
        });
    }
