...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("5d84afe1-021c-4111-93c2-402e5d38aa02 -1107955232912757214 app1 app1".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in app1 package as a set of config entries
        return configLoader.fromResource("app1/settings");
    }
